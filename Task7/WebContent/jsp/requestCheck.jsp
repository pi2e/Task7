...
<div class="container">
	...
	<form class="form-horizontal" method="post" role="form" action="requestCheck.do">
		...
		<div class="form-group">
			<label for="ledgerBalance" class="control-label col-xs-2">Ledger
				Balance</label>
			<div class="col-xs-3">
		...
		<div class="form-group">
			...
			<div class="col-xs-3">
				<input type="text" class="form-control" id="withdrawAmount"
					placeholder="Amount" value="${form.withdrawAmount}" name="withdrawAmount">
			</div>
		</div>
